...
public class PersonController {
    ...
    public PersonResponseDto save(@RequestBody PersonRequestDto personRequestDto) {
        PersonServiceDto personServiceDto = personService.savePerson(requestMapper.toServiceDto(personRequestDto));

        return requestMapper.toPersonResponseDto(personServiceDto);
    }
